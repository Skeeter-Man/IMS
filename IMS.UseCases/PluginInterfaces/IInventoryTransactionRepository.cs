...
namespace IMS.UseCases.PluginInterfaces
{
    public interface IInventoryTransactionRepository
    {
        ...
        Task<IEnumerable<InventoryTransaction>> GetInventoryTransactionsAsyc(string inventoryName, DateTime? dateFrom, DateTime? dateTo, InventoryTransactionType? transactionType);
    }
}